...
const Sidebar = () => {
    ...
    return (
        <aside className="h-screen md:block hidden lg:w-80 md:w-100 sticky top-0 py-10 px-6 dark:bg-dark bg-light space-y-8  !duration-300 !transition-colors border-r">
